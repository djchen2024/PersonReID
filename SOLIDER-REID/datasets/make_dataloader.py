...
from .mm import MM
from .reid_CUSTOM_v1 import reid_CUSTOM_v1 # DJ
from .reid_CUSTOM_v2 import reid_CUSTOM_v2 # DJ
from .reid_CUSTOM_VIDEO import reid_CUSTOM_VIDEO # DJ
__factory = {
    'market1501': Market1501,
    'MSMT17': MSMT17,
    'mm': MM,
    'reid_CUSTOM_v1': reid_CUSTOM_v1,      # DJ
    'reid_CUSTOM_v2': reid_CUSTOM_v2,      # DJ
    'reid_CUSTOM_VIDEO': reid_CUSTOM_VIDEO,      # DJ
}
