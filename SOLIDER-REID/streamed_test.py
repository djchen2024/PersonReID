...
from processor import do_inference, do_streamed_inference_clothes, do_streamed_inference_faces
...
if __name__ == "__main__":
    ...
    #    do_streamed_inference_clothes(cfg, model, val_loader, num_query)
       do_streamed_inference_faces(cfg, model, val_loader, num_query)
